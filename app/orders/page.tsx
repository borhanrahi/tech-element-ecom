...
import { ArrowLeft, Package, ShoppingBag, Calendar, DollarSign, Truck, Headphones, RotateCcw, Search } from 'lucide-react';
      ...
      <div className="container-custom py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <Link href="/">
              <Button variant="ghost" className="text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <Card className="border-0 shadow-lg bg-white">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">
                    {orders.length > 0 ? new Date(orders[0].orderDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric' }) : '-'}
                  </div>
                  <div className="text-sm text-gray-600">
                    Last Order
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100">
                <CardContent className="p-6 text-center">
                  ...
                  <Button variant="outline" className="w-full border-blue-200 hover:bg-blue-50 transition-colors">
                    Track Package
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100">
                <CardContent className="p-6 text-center">
                  ...
                  <Button variant="outline" className="w-full border-green-200 hover:bg-green-50 transition-colors">
                    Return Item
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100">
                <CardContent className="p-6 text-center">
                  ...
                  <Button variant="outline" className="w-full border-purple-200 hover:bg-purple-50 transition-colors">
                    Contact Support
                  </Button>
                </CardContent>
              </Card>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-r from-gray-900 to-black text-white">
              <CardContent className="p-8 text-center">
                <h3 className="text-2xl font-bold mb-4">Premium Customer Experience</h3>
                <p className="text-gray-300 mb-6 max-w-3xl mx-auto">
                  As a valued Tech Element customer, you have access to our premium support services, 
                  priority shipping, and exclusive member benefits.
                </p>
